...
public:
  ...
  [[nodiscard]] constexpr const Vec3 &x() const noexcept { return x_; }
  [[nodiscard]] constexpr const Vec3 &y() const noexcept { return y_; }
  [[nodiscard]] constexpr const Vec3 &z() const noexcept { return z_; }
